...
function ProjectsHeader({ username, onLogout }) {
  ...
  return (
    <header className="min-h-16 text-white shadow-xl flex items-center justify-between px-4 sm:px-6 sticky top-0 z-10 flex-shrink-0" style={{ backgroundColor: 'var(--header-bg)' }}>
