  ...
  return (
    ...
    >
      ...
      <div id="desktop-full-header" className="min-h-16 hidden md:flex items-center justify-between w-full">
        ...
        {/* Direita: chat e usuário / cadastro e login */}
        <div className="flex items-center space-x-4">
          {isLoggedIn ? (
            <>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 p-1 rounded-lg cursor-pointer transition duration-150"
                >
                  <div
            ...
            <>
              <a
                href="/signup"
                className="text-white text-base font-semibold px-4 py-2 rounded-lg transition duration-150 hover:bg-neutral-800"
              >
                Crie a sua conta
              </a>
              <a
